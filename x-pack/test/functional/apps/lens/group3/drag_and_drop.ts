  ...
  describe('lens drag and drop tests', () => {
    ...
    describe('dropping between layers', () => {
      it('should move the column', async () => {
        ...
        await PageObjects.lens.dragDimensionToDimension({
          from: 'lns-layerPanel-0 > lnsXY_xDimensionPanel > lns-dimensionTrigger',
          through: 'lns-layerPanel-1 > lnsXY_xDimensionPanel > lns-empty-dimension',
          to: 'lns-layerPanel-1 > lnsXY_xDimensionPanel > lnsDragDropExtraDrops >lnsDragDrop',
        });
        ...
        await PageObjects.lens.dragDimensionToDimension({
          ...
          through: 'lns-layerPanel-1 > lnsXY_yDimensionPanel > lns-empty-dimension',
          to: 'lns-layerPanel-1 > lnsXY_yDimensionPanel > lnsDragDropExtraDrops >lnsDragDrop',
        });
      ...
      it('swaps dimensions', async () => {
        ...
        await PageObjects.lens.dragDimensionToDimension({
          from: `lns-layerPanel-1 > lnsXY_splitDimensionPanel > lns-dimensionTrigger`,
          through: `lns-layerPanel-0 > lnsXY_splitDimensionPanel > lns-dimensionTrigger`,
          to: `lns-layerPanel-0 > lnsXY_splitDimensionPanel > lnsDragDrop-swap`,
        });
      ...
      it('can combine dimensions', async () => {
        await PageObjects.lens.dragDimensionToDimension({
          from: `lns-layerPanel-0 > lnsXY_splitDimensionPanel > lns-dimensionTrigger`,
          through: `lns-layerPanel-1 > lnsXY_splitDimensionPanel > lns-dimensionTrigger`,
          to: `lns-layerPanel-1 > lnsXY_splitDimensionPanel > lnsDragDrop-combine`,
        });
