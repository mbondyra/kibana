...
const getButtonCopy = (title: string) => {
  ...
  const modalDesc = i18n.translate('xpack.lens.layer.unlinkModal.unlinkAnnotationGroupDescription', {
...
const UnlinkConfirmModal = ({
  ...
  const onChangeShouldShowModal: EuiCheckboxProps['onChange'] = useCallback(({ target }) => setSkipDeleteModalLocal(target.checked), []);
