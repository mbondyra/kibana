...
export const editPanelsOperation = defineOperation({
  schema: z
    ...
    .describe(
      'Edit panels in place by panelId: ES|QL Lens or Vega (source "request", renderer kept), markdown and custom_content (source "config"). Non-ES|QL panels cannot be edited; replace them only with user approval.'
    ),
