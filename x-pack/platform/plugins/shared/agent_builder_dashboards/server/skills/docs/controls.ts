...
export const controlsDoc: DashboardSkillDoc = {
  name: 'controls',
  type: 'reference',
  title: 'Controls',
  description:
    'Interactive filters pinned above the dashboard: when to add them, the three control types, their required fields and server defaults, and how to remove them.',
  body: `Controls are interactive filters pinned above the dashboard that let users explore data without editing queries. Add them with \`add_controls\` and remove them by id with \`remove_controls\`.
