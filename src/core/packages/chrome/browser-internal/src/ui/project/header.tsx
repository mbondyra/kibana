...
export interface Props extends Pick<ComponentProps<typeof HeaderHelpMenu>, 'isServerless'> {
  ...
  onProjectRoutingChange?: (newProjectRouting: ProjectRouting) => void;
  cpsManager?: { fetchProjects: () => Promise<{ origin: any; linkedProjects: any[] }> };
}
...
export const ProjectHeader = ({
  ...
  console.log('ProjectHeader received:', { projectRouting, cpsManager, hasCps: !!cpsManager });

  const topBarStyles = css`
    box-shadow: none !important;
  `;

  console.log('Rendering ProjectHeader with props:', { projectRouting$, onProjectRoutingChange });
